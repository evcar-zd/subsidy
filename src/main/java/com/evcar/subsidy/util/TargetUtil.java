...
//        Long chargeTime = Long.valueOf(0);                  //近似线性中段充电时间(单位：S)
//        Long dischargeTime = Long.valueOf(0);               //近似线性中段放电时间(单位：S)
//        Long dischargeTotalTime = Long.valueOf(0) ;         //放电总时长(单位：S)
...
//                    if(bmsData.getCollectTime() != null && beforeBmsData.getCollectTime() != null) {
//                        Long time = DateUtil.getSeconds(beforeBmsData.getCollectTime(), bmsData.getCollectTime());
//                        dischargeTotalTime += (time > 0 && bmsData.getBatteryGroupStatus() == 1) ? time : 0 ;
//                    }
//
//                }
...
//        countData.setDischargeTotalTime(dischargeTotalTime) ;
