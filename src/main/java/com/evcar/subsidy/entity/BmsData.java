...
public class BmsData implements Serializable {
    ...
    private BigDecimal alowableVoltage ;        //最高允许充电端电压
    private BigDecimal alowableCurrent ;        //最高允许充电电流
    ...
    private BigDecimal totalVoltage ;           //可充电储能装置电压
    private Integer dcdcStatus ;                //DC_DC状态
    private Integer runStatus ;                 //运行状态 0x01:充电，0x02:行驶，0x03:停止状态
    ...
    private BigDecimal nominalEnergy ;          //额定能量
    private BigDecimal nominalVoltage ;         //额定电压
    ...
    public BigDecimal getAlowableVoltage() {
        return alowableVoltage;
    }

    public void setAlowableVoltage(BigDecimal alowableVoltage) {
        this.alowableVoltage = alowableVoltage;
    }

    public BigDecimal getAlowableCurrent() {
        return alowableCurrent;
    }

    public void setAlowableCurrent(BigDecimal alowableCurrent) {
    ...
    public BigDecimal getNominalEnergy() {
        return nominalEnergy;
    }

    public void setNominalEnergy(BigDecimal nominalEnergy) {
